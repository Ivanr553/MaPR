...
namespace Marine_Permit_Palace.Data.Migrations
{
    ...
    [Migration("20180628030029_AddUserAssigneeTables")]
    partial class AddUserAssigneeTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DataStorage", b =>
                {
                    b.Property<Guid>("IdDataStorage")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("IdDataStorage");

                    b.ToTable("Data_Storage");
                });
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentAssigneeIntermediate", b =>
                {
                    b.Property<Guid>("IdActiveDocumentId");

                    b.Property<string>("IdAssigneeId");
                    ...
                    b.Property<bool>("IsAllowedApprove");

                    b.Property<bool>("IsAllowedAssignFields");

                    b.Property<bool>("IsAllowedEdit");

                    b.Property<bool>("IsAllowedSubmit");

                    b.Property<bool>("IsDelete");

                    b.HasKey("IdActiveDocumentId", "IdAssigneeId");

                    b.HasIndex("IdAssigneeId");

                    b.ToTable("Document_Assignee_Intermediate");
                });
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentSignatureField", b =>
                {
                    ...
                    b.Property<Guid>("SignatureDataId");

                    b.HasKey("IdSubmittedDocumentId", "IdFormName");

                    b.HasIndex("AssigneeId");

                    b.HasIndex("SignatureDataId");
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.StoredToken", b =>
                {
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentAssigneeIntermediate", b =>
                {
                    b.HasOne("Marine_Permit_Palace.Models.SubmittedDocument", "ActiveDocument")
                        .WithMany("DocumentAssigneeIntermediates")
                        .HasForeignKey("IdActiveDocumentId");

                    b.HasOne("Marine_Permit_Palace.Models.ApplicationUser", "Assignee")
                        .WithMany("DocumentAssigneeIntermediates")
                        .HasForeignKey("IdAssigneeId");
                });

            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentCheckBoxField", b =>
                {
                    b.HasOne("Marine_Permit_Palace.Models.ApplicationUser", "Assignee")
                        .WithMany("AssignedDocumentCheckBoxFields")
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentFormField", b =>
                {
                    b.HasOne("Marine_Permit_Palace.Models.ApplicationUser", "Assignee")
                        .WithMany("AssignedDocumentFormFields")
                        .HasForeignKey("AssigneeId");
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.DocumentSignatureField", b =>
                {
                    b.HasOne("Marine_Permit_Palace.Models.ApplicationUser", "Assignee")
                        .WithMany("AssignedDocumentSignatureFields")
                        .HasForeignKey("AssigneeId");
                    ...
                    b.HasOne("Marine_Permit_Palace.Models.DataStorage", "SignatureData")
                        .WithMany("DocumentSignatureFields")
                        .HasForeignKey("SignatureDataId");
                });
            ...
            modelBuilder.Entity("Marine_Permit_Palace.Models.SubmittedDocument", b =>
                {
                    ...
                    b.HasOne("Marine_Permit_Palace.Models.ApplicationUser", "Assigner")
