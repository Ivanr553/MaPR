...
class AddedUserPermissions extends React.Component<Props, any> {
    ...
    checkIfAssignedUser = (): boolean => {
        return this.props.assigned_user === this.props.user
    }
    ...
    render() {
        ...
        return (
            <div className='AddedUserPermissions'>
                <div className='user-permissions-title'>User</div>
                    <div className='user-permissions-field'>{this.props.user.name}</div>
                <div className='user-permissions-title'>Dod Id</div>
                    <div className='user-permissions-field'>{this.props.user.dod_id}</div>
                ...
                <div className='user-permissions-title'>Assigned To</div>
                    <Switch offInnerText={'Not Assigned'} onInnerText={'Assigned'} field={null} user={this.props.user} handleSwitchToggle={this.props.handleAssignedUserToggle} initialToggle={this.checkIfAssignedUser()}/>
            </div>
        );
    }
}
